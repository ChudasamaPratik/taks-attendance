...
const ProfilePage = () => {
    ...
    const fetchSalaryRecords = async () => {
        try {
            ...
            const token = localStorage.getItem('token'); // Adjust based on how token is stored
    ...
    const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        try {
            const token = localStorage.getItem('authToken'); // Adjust based on how token is stored
            if (currentRecord) {
            ...
            alert("An error occurred while saving the salary record.");
        }
    };
