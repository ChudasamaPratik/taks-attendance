...
const Calendar = () => {
    ...
    console.log(centralDropdownOpen);
    ...
    const getAttendanceClass = (type) => {
        switch (type) {
            case 'Present':
                return 'bg-green-300 hover:bg-green-200'; // Lighter green
            case 'Leave':
                return 'bg-indigo-300 hover:bg-indigo-200'; // Lighter indigo
            case 'Cancel Leave':
                return 'bg-yellow-300 hover:bg-yellow-200'; // Lighter yellow
            case 'Extra Day':
                return 'bg-blue-300 hover:bg-blue-200'; // Lighter blue
            default:
                return 'bg-gray-300 hover:bg-gray-200'; // Lighter gray
        }
    };
    ...
    const submitAttendance = async (selectedDate, option, setCentralDropdownOpen) => {
        ...
        const attendanceData = {
            ...
            notes: '' // Note the change from 'note' to 'notes' to match the backend
        };
                    ...
                    day ? (
                        <div
                            ...
                            ${day.date.toDateString() === new Date().toDateString()
                                    ? 'border-2 border-red-600 font-bold'
                                    : 'border-gray-700'}`}
                        ...
                        >
                            ...
                            <div className="mt-2">
                                <p
                                    className={`text-white py-2 rounded-lg transition ${getAttendanceClass('Present')}`}
                                >
                                    Present
                                </p>
                            </div>
