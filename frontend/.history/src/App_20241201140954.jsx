...
import NavButtons from './components/NavButtons'; // Assuming NavButtons is in a components folder
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/profile" element={isLoggedIn ? <Task /> : <Navigate to="/login" />} />
